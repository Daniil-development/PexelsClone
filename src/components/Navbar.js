...
const Navbar = () => {
    return (
        <div className="Navbar_container__XDcRT Navbar_transparent__OTbWS Navbar_homePage__lGPlj">
            <nav
                className="Wrapper_maxWidth__WMxko spacing_noMargin__Q_PsJ spacing_oversized-padding-right-30__13wIX spacing_desktop-padding-right-30__i_iPB spacing_mobile-padding-right-8__z83PP spacing_tablet-padding-right-15__00lzO spacing_oversized-padding-left-30__e3BnR spacing_desktop-padding-left-30__r8tFu spacing_mobile-padding-left-8__w5_Dz spacing_tablet-padding-left-15__IIbkL Navbar_flex__YJo9Y">
                <hr className="Wrapper_hack__ULvma"/>
                <div className="Navbar_left__Lvfsy"><a
                    className="Navbar_logo__C1wHI Link_link__mTUkz clickable_clickable__Klxi1 spacing_noMargin__Q_PsJ"
                    href="/client/public">
                    <svg width="130" height="50"
                        ...
                        <g transform="translate(-3894 2762)">
                            <rect width="50" height="50" rx="8" transform="translate(3894 -2762)"
                                  fill="#07a081"></rect>
                            <path
                                ...
                                transform="translate(3880 -2773)" fill="#fff"></path>
                            <path
                                ...
                                transform="translate(3959 -2728)" fill="#fff"></path>
                        </g>
                    </svg>
                    <svg width="40" height="40"
                         className="DisplayNone_mobile-tablet__6iQd1 spacing_noMargin__Q_PsJ spacing_oversized-margin-right-50__Z6BXP spacing_desktop-margin-right-30__C4NEG spacing_mobile-margin-right-15__uM70E spacing_tablet-margin-right-15__zeT1z"
                         viewBox="0 0 50 50">
                        <g transform="translate(-3894 2762)">
                            <rect width="50" height="50" rx="8" transform="translate(3894 -2762)"
                                  fill="#07a081"></rect>
